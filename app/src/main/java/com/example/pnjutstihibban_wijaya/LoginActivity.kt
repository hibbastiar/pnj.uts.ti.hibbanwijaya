package com.example.pnjutstihibban_wijaya
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnLogin.setOnClickListener {
            ...
            Log.d("TAG", edtPass.text.toString())
            if (edtUname.text.toString().equals("hibban@gmail.com") && edtPass.text.toString()
                    .equals("1234")
            ) {
                val data = getSharedPreferences("Profile", Context.MODE_PRIVATE)
                val edit = data.edit()
                edit.putString("email", "hibban@gmail.com")
                edit.putString("nim", "2207411019")
                edit.putString("nama", "hibban")
